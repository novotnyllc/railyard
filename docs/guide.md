...
Railyard turns "go do X" into a verified, delivered result. The public
...
- [AGENTS.md](../AGENTS.md) — repository charter and verification commands.
- `plugins/railyard/skills/*/SKILL.md` — the skills loaded by Codex and Claude
  Code.
- `docs/agents/` — local workflow contracts and operating rules.
- `docs/plans/` and `docs/specs/` — implementation records kept with the
  source.
