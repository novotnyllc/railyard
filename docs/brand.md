...
roundhouse, the toolbox. Nothing in the family is a "-master," a "-man," or
a boast.

## Names and taglines

| Plugin | One-liner | Tagline |
| --- | --- | --- |
...
requires decoding. The value proposition always lands in the first sentence;
the metaphor seasons, never carries.
...
- **Frame**: rounded-square badge with a thick border. Positive (charcoal
  ...
  belong to the family; the tart badge fills its ground in pastry gold —
  it is the family's dessert, a deliberate wink.
...
> Minimal flat vector logo emblem: [SUBJECT], [ACCENT] accent, in a
> rounded-square badge frame with a thick border, geometric flat vector
> composition, crisp uniform line weight, charcoal gray outlines on a clean
> white background, modern and simple, matching a consistent icon family,
