---
name: model-routing
description: "Resolve one bounded model, effort, transport, and budget decision through yardmaster/model-routing/v1. Use before model-specific task, subagent, provider-review, or steering actions."
---

# Model routing

`yardmaster:model-routing` is the only public model, effort, budget, and
...
Every request carries exact `"contractVersion":"yardmaster/model-routing/v1"`.
