...
| Either → ChatGPT Pro one-shot review | `yardmaster:oracle`, which has its own invocation rules and requires a ChatGPT Pro subscription (see that skill for cached availability detection) |
