...
export default defineConfig({
  ...
  redirects: {
    ...
    '/delivery/model-routing/budgets': { status: 301, destination: '/delivery/model-routing/' },
    '/delivery/model-routing/learning': { status: 301, destination: '/delivery/model-routing/' },
    '/delivery/model-routing/policy': { status: 301, destination: '/delivery/model-routing/' },
    '/delivery/model-routing/tiers': { status: 301, destination: '/delivery/model-routing/' },
    '/delivery/model-routing/worked-runs': { status: 301, destination: '/delivery/model-routing/' },
