...
Railyard gives every work unit one decision for model, effort, transport, and budget before the carrier starts. The route arrives with a receipt, so the operator can see what tier ran and how that decision reached a merged, proven result.
