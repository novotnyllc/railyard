...
const required = ['favicon.svg', 'favicon-16.png', 'favicon-32.png', 'apple-touch-icon.png', 'assets/railyard-icon.png', 'og/railyard-og.svg', 'og/railyard-og.png', 'assets/hero-rail.svg'];
...
for (const file of ['favicon.svg', 'assets/hero-rail.svg', 'og/railyard-og.svg', ...icons.map((icon) => `assets/scenarios/${icon}.svg`)]) {
